"""
Revision 005
-attempt to implement auto-tuning via bh factor
-set bh factor automatically based on set-point
...
Kprop = .28                                       # 0.1 .05 0.6 .10 proportional gain - needs tuning
Kint = 0.5                                      #.06 .1 0.2 0.1875 0.02 integral gain - needs tuning
...
for n in range(0,magnets_num):
    bh_factor = abs(setpoints[n])*0.0012+0.1251
    Kp = Kprop*bh_factor                                    
    Ki = Kint*bh_factor   
