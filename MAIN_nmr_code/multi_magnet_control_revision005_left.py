...
control_io = feedback_controller_io(
	...
	hall_sensor_address=[1, 2, 3, 4, 5 , 6 , 7 , 8 , 9],			# Pin address assignment
	actuation_forward_direction_address=[2, 6, 3, 7, 10, 14, 9 , 15, 18],
	actuation_reverse_direction_address=[0, 4, 1, 5, 8 , 12, 11, 13, 16],
