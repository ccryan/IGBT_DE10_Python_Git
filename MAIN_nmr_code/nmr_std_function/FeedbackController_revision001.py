class FeedbackController(object):
  """ A feedback controller for controlling magnetization of electropermanent magnets. 
  The controller continuously calculates an error value as the difference between a desired setpoint and a measured process 
  ...
  def update(self, input):
    ...
    if self.setpoint_weighting:
      ...
      self._proportional = self.Kp * (self.beta * self.setpoint - input)
  ...
  def output_limits(self):
      ...
      See also the *output_limts* parameter in :meth:`feedback_controller.__init__`.
      """
